...
public final class AccountsPage extends Widget {
    ...
    public void onFloatFloatFloatMatrix4f(float value, float value2, float value3, Matrix4f matrix4f) {
        ...
        int foreground = Theme.foreground();
        int muted = Theme.mutedFg();

        TextShader.onFloatStringFloatFloatIntFloatMatrix4f(value, "Account Manager", 20.0F, x, foreground, y, matrix4f);
        TextShader.onFloatStringFloatFloatIntFloatMatrix4f(value, "Текущий: " + getCurrentName(), 14.0F, x, foreground, y + 28.0F, matrix4f);
        TextShader.onFloatStringFloatFloatIntFloatMatrix4f(value, "Сохранить текущий аккаунт", 14.0F, x, foreground, y + 60.0F, matrix4f);
